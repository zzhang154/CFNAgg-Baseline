...
nohup ./ns3 run scratch/innetwork-test.cc -- --topotype=1 --input_para="no-agg:46k-app30-isp200-AIMD-loss5" 2>&1 | sed -r "s/\x1B\[[0-9;]*[mK]//g" > 2.22-new-log/no-agg-46k-app30-isp200-AIMD-loss5.log &
