...
public:
   ...
   */
  Ptr<QuicMyServer> GetServer (void);

private:
  ObjectFactory m_factory; //!< Object factory.
  Ptr<QuicMyServer> m_server; //!< The last created server application
};
...
public:
  ...
  /**
   * \brief Return the last created client.
   *
   * This function is mainly used for testing.
   *
   * \returns a Ptr to the last created client application
   */
  Ptr<QuicMyClient> GetClient (void);

private:
  ObjectFactory m_factory; //!< Object factory.
  Ptr<QuicMyClient> m_client; //!< The last created client application
};
